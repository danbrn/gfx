...
template <typename T> struct rect {
    ...
    constexpr rect(vec2d_t<T> p, vec2d_t<T> s) noexcept
        : position{p}, size{s} {}

    auto contains(rect const &other) const -> bool {
    ...
    auto overlaps(rect const &other) const -> bool {
